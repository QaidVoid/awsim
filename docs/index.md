...
hero:
  ...
  tagline: Single binary. 37 services. No auth tokens. No paywalls. No cloud dependency.
  actions:
    - theme: brand
      text: Get Started
...
features:
  ...
  - title: 37 AWS Services
    details: S3, DynamoDB, SQS, Lambda, Cognito, IAM, and 31 more — all in a single binary under 30 MB.
